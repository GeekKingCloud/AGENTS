...
REQUIRED_FILES = {
    ...
    "workflows/pull-request-reviews.md",
...
POLICY_SMOKE_MARKERS = {
    ...
    "AGENTS.md": [
        ...
        "Planning alone does not authorize implementation or expansion",
        "internal control points",
        "completion evidence and required gates",
        "Skill selection supplies procedure, never action authority",
    ...
    "instructions/personal-assistant.md": [
        ...
        "Report, then wait:",
        "within higher-level runtime constraints",
    ],
    "instructions/development.md": [
        ...
        "owns focused versus broad check cadence",
    ],
    "instructions/autodev.md": [
        "lumber-hack",
        "atoshell",
        "g8ldfish",
        "experimental, not a default dependency",
    ],
    "workflows/implementation-finish.md": [
    ...
    "workflows/verification.md": [
        ...
        "Accumulate related fixes",
        "Do not default to an entire test file or suite after every small fix",
        "project-required full gate on the exact PR, merge, or release candidate",
        "Verified",
        "Inferred",
        "Not checked",
        "Blocked",
